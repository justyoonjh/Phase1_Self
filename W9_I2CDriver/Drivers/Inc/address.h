...
#define SPI1_CLK()		(RCC->APB2ENR |= (1 << 12))
#define SPI2_CLK()		(RCC->APB1ENR |= (1 << 14))
#define SPI3_CLK() 		(RCC->APB1ENR |= (1 << 15))
#define SPI4_CLK()		(RCC->APB2ENR |= (1 << 13))
...
#define I2C_CR2_ITERREN		5
#define I2C_CR2_ITEVTEN		6
#define I2C_CR2_ITBUFEN		7
#define I2C_CR2_DMAEN		8
#define I2C_CR2_LAST			9
