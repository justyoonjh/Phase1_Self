...
#define GPIOD				((GPIO_RegMap_t*) GPIOC_BASEADDR)
#define GPIOE				((GPIO_RegMap_t*) GPIOC_BASEADDR)
#define GPIOF				((GPIO_RegMap_t*) GPIOC_BASEADDR)
#define GPIOG				((GPIO_RegMap_t*) GPIOC_BASEADDR)
#define GPIOH				((GPIO_RegMap_t*) GPIOC_BASEADDR)
